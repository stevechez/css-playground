        ...
        <div>
            ...
            <header className="header">
                <div className="header__logo-box">
                    <img src="/img/tours/logo-white.png" alt="Logo" className="header__logo" />
                </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-1-of-2">
                            <div className="composition">
                                ...
                                <img srcset="/img/tours/nat-1.jpg 300w, /img/tours/nat-1-large.jpg 1000w"
                                    sizes="(max-width: 56.25em) 20vw, (max-width: 37.5em) 30vw, 300px"
                                    alt="Photo 1"
                                    className="composition__photo composition__photo--p1"
                                    src="/img/tours/nat-1-large.jpg" />

                                <img srcset="/img/tours/nat-2.jpg 300w, /img/tours/nat-2-large.jpg 1000w"
                                    sizes="(max-width: 56.25em) 20vw, (max-width: 37.5em) 30vw, 300px"
                                    alt="Photo 2"
                                    className="composition__photo composition__photo--p2"
                                    src="/img/tours/nat-2-large.jpg" />

                                <img srcset="/img/tours/nat-3.jpg 300w, /img/tours/nat-3-large.jpg 1000w"
                                    sizes="(max-width: 56.25em) 20vw, (max-width: 37.5em) 30vw, 300px"
                                    alt="Photo 3"
                                    className="composition__photo composition__photo--p3"
                                    src="/img/tours/nat-3-large.jpg" />
                ...
                <section className="section-stories">
                    <div className="bg-video">
                        <video className="bg-video__content" autoplay muted loop>
                            ...
                            <source src="/img/tours/video.webm" type="video/webm" />
                    ...
                    <div className="row">
                        <div className="story">
                            <figure className="story__shape">
                                <img src="/img/tours/nat-8.jpg" alt="Person on a tour" className="story__img" />
                    ...
                    <div className="row">
                        <div className="story">
                            <figure className="story__shape">
                                <img src="/img/tours/nat-9.jpg" alt="Person on a tour" className="story__img" />
            ...
            <footer className="footer">
                <div className="footer__logo-box">
                    ...
                    <picture className="footer__logo">
                        <source srcset="/img/tours/logo-green-small-1x.png 1x, /img/tours/logo-green-small-2x.png 2x"
                                media="(max-width: 37.5em)" />
                        <img srcset="/img/tours/logo-green-1x.png 1x, /img/tours/logo-green-2x.png 2x" alt="Full logo" src="/img/tours/logo-green-2x.png" />
                    </picture>
            ...
            <div className="popup" id="popup">
                <div className="popup__content">
                    <div className="popup__left">
                        <img src="/img/tours/nat-8.jpg" alt="Tour photo" className="popup__img" />
                        <img src="/img/tours/nat-9.jpg" alt="Tour photo" className="popup__img" />
                    </div>
